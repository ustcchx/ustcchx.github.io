...
My current research focuses on generative modeling, with a particular interest in **diffusion & flow-based models**. I have also worked on model merging and efficient transfer learning, with a focus on parameter and memory efficiency.
